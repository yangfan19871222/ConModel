...
if __name__ == '__main__':
    ...
    batch_size = 128
    train = FaceDataIter(batch_size, os.path.join(root_path, './imglist_stage4/train.txt'), (3, 24, 24), 51200, begin = 0)
    val = FaceDataIter(batch_size, os.path.join(root_path, './imglist_stage4/train'), (3, 24, 24), 5120, begin = 2500000)
    device = mx.gpu(1)
    lr = 0.01
  ...
  #      label_num = 1
    ...
    model.save('mtcnn_online_output2_35_glass_resize_24x24')
